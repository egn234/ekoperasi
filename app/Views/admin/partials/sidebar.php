      ...
      <ul class="metismenu list-unstyled" id="side-menu">
        ...
        <li>
          ...
          <ul class="sub-menu" aria-expanded="false">
            ...
            <li><a href="<?= url_to('admin/register/list') ?>" data-key="t-user-list">Daftar Anggota Baru</a></li>
            <li><a href="<?= url_to('admin/user/closebook-list') ?>" data-key="t-user-list">Pengajuan Closebook</a></li>
          </ul>
        </li>
