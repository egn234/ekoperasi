    ...
    <div class="divide-y divide-slate-50">
      <?php if (empty($daftar_notif)): ?>
        <div class="py-20 md:p-12 text-center">
          ...
          <p class="text-slate-400 text-xs md:text-sm">Semua aman terkendali, Master!</p>
        </div>
      <?php endif; ?>
          ...
          <div class="flex gap-3 md:gap-4 items-start">
            ...
            <div class="flex-1 min-w-0 pt-0.5">
              <div class="flex justify-between items-start gap-2 mb-1">
                ...
                <?php if ($isUnread): ?>
                  <form method="post" action="<?= base_url('admin/notification/tbl/mark-as-read') ?>" class="md:hidden">
