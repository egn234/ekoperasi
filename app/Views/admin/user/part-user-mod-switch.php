<div class="text-center mb-6">
    ...
    <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">
        ...
        <span class="<?= $user[0]['flag'] == 0 ? 'text-emerald-500' : 'text-red-500' ?>"><?= $user[0]['flag'] == 0 ? 'AKTIF' : 'NONAKTIF' ?></span>?
    </p>
</div>
...
<div class="flex gap-3">
    ...
    <a href="<?= url_to('admin_switch_user', $iduser) ?>" class="flex-1 py-3 bg-blue-600 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-blue-700 shadow-lg shadow-blue-200 text-center transition-all hover:scale-[1.02]">
        Konfirmasi
    </a>
</div>