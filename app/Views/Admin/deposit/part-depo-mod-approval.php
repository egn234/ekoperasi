...
<div class="modal-body">
    <div class="mb-3">
        ...
        <br>
        <?php if ($flag == 0) {?>
            <form action="<?= url_to('admin_batalkan_simpanan', $a->iddeposit)?>" id="formSheet" method="post">
                <div class="mb-3">
...
<div class="modal-footer">
    ...
    <?php if($flag == 1){?>
        <a href="<?= url_to('admin_konfirmasi_simpanan', $a->iddeposit)?>" class="btn btn-success">Terima</a>
    <?php }else{?>
