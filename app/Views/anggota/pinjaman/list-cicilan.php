                  ...
                  <?php if($duser->status_pegawai == 'tetap'){?>
                    <div class="col-sm-6">
                      <div class="btn-group float-end">
                        ...
                        <?php else: ?>
                          <a class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#topUp" data-id="<?=$detail_pinjaman->idpinjaman?>" title="Top Up tidak tersedia">
                            <i class="fa fa-upload"></i> Top Up Pinjaman
                          </a>
                        <?php endif; ?>
                      </div>
              ...
              <div class="card-body">
                ...
                <?php if($detail_pinjaman->status == 4){?>
                  ...
                  <div class="mb-3">
                    ...
                    <div class="text-muted h6">
                      <?=$detail_pinjaman->angsuran_bulanan - $total_paid_installments?> Bulan
                    </div>
                  </div>
                  <hr>
                  <div class="mb-3">
