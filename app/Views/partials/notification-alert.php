...
<div class="mb-6 p-4 rounded-2xl border <?= $theme['bg'] ?> <?= $theme['border'] ?> backdrop-blur-sm flex items-start gap-4 shadow-sm relative group overflow-hidden transition-all duration-300 hover:shadow-md animate-in fade-in slide-in-from-top-2">
	<!-- Icon -->
