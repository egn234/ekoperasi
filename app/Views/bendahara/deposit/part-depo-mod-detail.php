...
<div class="modal-footer">
    ...
    <?php if ($a->status == 'diproses bendahara') {?>
        <a href="<?= url_to('bendahara_batalkan_simpanan', $a->iddeposit)?>" class="btn btn-danger">Batalkan Pengajuan</a>
        <a href="<?= url_to('bendahara_konfirmasi_simpanan', $a->iddeposit)?>" class="btn btn-success <?= ($confirmation)?'disabled':''?>">Konfirmasi Pengajuan</a>
    <?php }?>
</div>
