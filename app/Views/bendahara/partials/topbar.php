                    ...
                    <?php foreach ($notification_list as $a): ?>
                        <?php if ($a->status == 'unread'): ?>
                            ...
                            <?php if ($a->pinjaman_id): ?>
                                <a href="<?= url_to('bendahara/pinjaman/list') ?>" data-id="<?php echo $a->id; ?>" class="update-notification text-reset notification-item">
                                    <div class="d-flex">
                            ...
                            <?php if ($a->deposit_id): ?>
                                <a href="<?= url_to('bendahara/deposit/list_transaksi') ?>" data-id="<?php echo $a->id; ?>" class="update-notification text-reset notification-item">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 avatar-sm me-3">
