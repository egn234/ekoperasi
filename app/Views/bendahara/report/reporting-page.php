                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <form action="<?= url_to('bendahara/report/print-potongan-pinjaman') ?>" method="post">
                                        <div class="row">
                                            <div class="col-sm-5">
                                                <div class="mb-3">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <form action="<?= url_to('bendahara/report/print-rekening-koran') ?>" method="post">
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <div class="mb-3">
                                ...
                                <div class="mb-3 mt-3">
                                    <h5>Rekap Tahunan</h5>
                                    <form action="<?= url_to('bendahara/report/print-rekap-tahunan') ?>" method="post">
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <div class="mb-3">
