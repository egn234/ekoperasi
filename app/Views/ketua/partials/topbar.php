  ...
  <div class="navbar-header">
    <div class="d-flex">
      ...
      <div class="navbar-brand-box">
        <a href="<?= url_to('dashboard_ketua')?>" class="logo logo-dark">
          <span class="logo-sm">
        ...
        <a href="<?= url_to('dashboard_ketua')?>" class="logo logo-light">
          <span class="logo-sm">
            <img src="<?=base_url()?>/assets/images/logo-sm.svg" alt="" height="24">
          </span>
          <span class="logo-lg">
    ...
    <div class="d-flex">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0 notif-dropdown" aria-labelledby="page-header-notifications-dropdown">
          <div class="p-3 border-bottom bg-light sticky-top" style="z-index:2;">
            <div class="row align-items-center">
              ...
              <div class="col-auto">
                <a href="<?= base_url('ketua/notification/mark-all-read') ?>" class="small text-reset text-decoration-underline"> Tandai semua sudah dibaca (<?= $notification_badges ?>)</a>
              </div>
            </div>
          </div>
          <div class="notif-scroll" style="max-height: 350px; overflow-y: auto;">
            ...
            <?php foreach ($notification_list_limited as $a): ?>
              <?php
                ...
                $url = $a->pinjaman_id ? url_to('ketua/pinjaman/list') : ($a->deposit_id ? url_to('ketua/deposit/list') : ($a->closebook == '1' ? url_to('ketua/user/closebook-list') : '#'));
      ...
      <div class="dropdown d-inline-block">
        ...
        <div class="dropdown-menu dropdown-menu-end">
          <!-- item-->
          <a class="dropdown-item" href="<?= url_to('ketua/profile')?>"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> Profil</a>
